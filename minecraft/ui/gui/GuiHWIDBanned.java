...
/*	static Clip clip; //must be static for resizing the window issue of double music
	...
	public GuiHWIDBanned(String reason)
	{
		...
		message = new IChatComponent[] {
				...
				new ChatComponentText(""),
				new ChatComponentText("You can appeal your ban at " + EnumChatFormatting.YELLOW + "Comming Soon").setChatStyle(
						new ChatStyle()
	...
	{
		super.initGui();
		this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height - 30, "Quit"));
