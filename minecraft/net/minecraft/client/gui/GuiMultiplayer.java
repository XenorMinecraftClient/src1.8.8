...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	Xenor.getInstance().getDiscordRP().update("Idle", "Multiplayer Menu");
    ...
    public void createButtons()
    {
        ...
        //Account Manager
        //this.buttonList.add(new GuiButton(901, 320, 7, 100, 20, I18n.format("Account Manager", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int x = 388;
        int y = 4;
        final ResourceLocation LOGO = new ResourceLocation("Xenor/logo.jpg");
       // drawImg(x, y, false, LOGO);
