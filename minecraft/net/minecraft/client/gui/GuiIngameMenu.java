...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(83, this.width / 2 - 100, this.height / 4 + 72 + i, 98, 20, I18n.format("Xenor Mods", new Object[0])));
        this.buttonList.add(new GuiButton(84, this.width / 2 + 2, this.height / 4 + 72 + i, 98, 20, I18n.format("Xenor GUI Editing", new Object[0])));
        //this.buttonList.add(new GuiButton(85, this.width / 2 - 100, this.height / 4 + 72 + i, 200, 20, I18n.format("Xenor", new Object[0])));
        GuiButton guibutton;
