...
import ui.button.GuiMainMenuButton;
import xenor.Xenor;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
		...
		int objHeight = 50;
		int objWidth = 50;
		int xMid = this.width / 2 - 55;
        
		String singleplayer = I18n.format("Singleplayer");
		String multiplayer = I18n.format("Multiplayer");
		String options = I18n.format("Options");
		String altmanager = I18n.format("AltManager");
		String exit = I18n.format("Exit");
		
		ScaledResolution sr = new ScaledResolution(mc);

        this.buttonList.add(new GuiMainMenuButton(0, xMid + 40, initHeight + 30, objWidth, objHeight, options));
        this.buttonList.add(new GuiMainMenuButton(4, xMid + 120, initHeight + 30, objWidth, objHeight, exit));
		this.buttonList.add(new GuiMainMenuButton(1, xMid - 120, initHeight + 30, objWidth, objHeight, singleplayer));
		this.buttonList.add(new GuiMainMenuButton(2, xMid - 40, initHeight + 30, objWidth, objHeight, multiplayer));
