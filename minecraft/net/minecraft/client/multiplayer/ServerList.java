...
import xenor.util.ServerDataFeatured;
...
public class ServerList
{
    ...
    private void loadFeaturedServers() throws IOException {
		
		this.addServerData(new ServerDataFeatured(MySQLUserCosmetics.getFeaturedServerName(1), MySQLUserCosmetics.getFeaturedServerAdress(1)));
		this.addServerData(new ServerDataFeatured(MySQLUserCosmetics.getFeaturedServerName(2), MySQLUserCosmetics.getFeaturedServerAdress(2)));
	}
