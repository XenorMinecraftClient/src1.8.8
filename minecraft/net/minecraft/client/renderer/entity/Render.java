...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderLivingLabel(T e, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            /*	if((boolean) SocketClient.isUser(((AbstractClientPlayer) e).getGameProfile().getName()) && e.ticksExisted > 10) {
		           	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Xenor/logo.jpg"));
