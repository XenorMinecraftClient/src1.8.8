...
extends GuiScreen {
    ...
    private String status = (Object)((Object)EnumChatFormatting.GRAY) + "No account selected";
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                AltManager altManager = Xenor.INSTANCE.altManager;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(fontRendererObj, sb2.append(AltManager.registry.size()).append(" accounts").toString(), width / 2, 10, -1);
        ...
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 = Xenor.INSTANCE.altManager;
    ...
    public void initGui() {
        ...
        //this.buttonList.add(new GuiButton(8, width - 200, 0, 100, 20, "Use Something else"));
        this.login.enabled = false;
        this.remove.enabled = false;
        this.rename.enabled = false;
    }
